...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="row">
    <div class="col-md-9 col-md-push-3">    
      <div class="content pagina-content" <?php print $content_attributes; ?>>
        <?php
            hide($content['comments']);
            hide($content['links']);
            hide($content['field_lead_image']);
            hide($content['field_lead_text']);
  ...
  <div class="row">
    <div class="col-md-4 col-xs-12">
      <h3>Praat met ons!</h3>
      <p>Vragen, ideeen, veel goede ideeen? Laat het ons weten.</p>
      <img class="pull-left" src="images\clock.jpg" style="margin-right:15px;">
      <div class="pull-left">
          <?php print render($content['field_team_meeting']); ?>
          <strong>Volgende Live Hangout</strong><br>
